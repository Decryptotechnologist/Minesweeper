...
public class Game extends Canvas implements Runnable {
    ...
    public static String TITLE = "Minesweeper";
...
//        }
        ...
        img = new BufferedImage(Minesweeper.getMainWidth(), Minesweeper.getMainHeight(), BufferedImage.TYPE_INT_RGB);
...
//            win();
    ...
    */
    public void win() {
        ...
        Minesweeper.setStatusBar("Time Bonus: "+timeBonus+" Accuracy Bonus: "+accuracyBonus+" Level Bonus: "+levelBonus);
        ...
        if(levelNo+1 < 21){//Game Levels Limit : Currently set to 8
            ...
            Minesweeper.setStatusBar("Game Complete!");
    ...
    */
    public void lose() {
        ...
        //if(Player.getLives() == 0){
            //levelNo = 1;
            Game.level = null;//.setLevelNo(levelNo);
            init();
    ...
    public static void loseGame() {
        ...
        System.out.println("Game: Lose Game!");
        Game.getGame().lose();
    }
