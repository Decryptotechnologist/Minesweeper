...
public class LoseMenu extends Menu {
    ...
    private final int menuImageW = Minesweeper.getMainWidth()+12;
    
    /**menuImageH variable of LoseMenu*/
    private final int menuImageH = Minesweeper.getMainHeight();
    ...
    */
    ...
    public void render(Game game, Graphics2D g2d) {
        ...
        if (System.currentTimeMillis() / 450 % 2 == 0) {
            ...
            Minesweeper.setStatusBar("Game Over!!!");
            ////////////////////////////////////////////////////////////////////
        } else {
...
//            Sound.stopAll();
            ...
            Game.level = new Level(1, Minesweeper.getMainWidth(), Minesweeper.getMainHeight());
