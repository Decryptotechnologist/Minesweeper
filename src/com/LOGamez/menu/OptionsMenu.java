...
//    private Configuration config;
    ...
    */
    ...
    private void initComponents() {
        ...
        lgePanelSize = new Dimension(Minesweeper.getMainWidth() - 40, Minesweeper.getMainHeight() - 20);
        ...
        mainPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(mainPanelImage, 0, -10, Minesweeper.getMainWidth() - 40, Minesweeper.getMainHeight() - 20, null);
            }
        };
...
//        jCheckBox16.setOpaque(false);
        ...
        Minesweeper.optionsWindow.add(mainPanel);
...
//                Sound.Menu3.loop();
            ...
            Minesweeper.addOptions();
            Minesweeper.setStatusBar("Options Menu");
            Minesweeper.optionsWindow.validate();
...
//    }
    ...
    */
    ...
    private void graphicsPanel_L_TopMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Graphics");
    ...
    private void gameplayPanel_L_CenterMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Gameplay");
    ...
    private void soundPanel_R_CenterMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Sound");
    ...
    private void restoreDefBtnMouseEntered(MouseEvent evt) {  
        ...
        Minesweeper.setStatusBar("Restore Defaults");
    }                                     
    ...
    private void restoreDefBtnMouseExited(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Developer");
    }                                    
    ...
    private void backBtnMouseEntered(MouseEvent evt) {                                      
        ...
        Minesweeper.setStatusBar("Back to Main Menu");
    }                                     
    ...
    private void back2MainMenu() {
        ...
        Minesweeper.removeOptions();
//        Sound.Menu3.stop();
        
        game.requestFocus();
        game.setMenu(null);
        game.stateManager.setState("menu");
        Minesweeper.setStatusBar("Ready");
        Minesweeper.revalidate();
    }
    ...
    private void creditsBtnMouseEntered(MouseEvent evt) {  
        ...
        Minesweeper.setStatusBar("Credits");
    }                                     
...
//        Sound.Menu3.stop();
        ...
        game.setCredits();
        game.requestFocus();
        Minesweeper.setStatusBar("Credits Menu");
    }
    ...
    private void cancelBtnMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Cancel");
    }                                     
    ...
    private void defineBtnMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Define Keys");
    }                                     
    ...
    private void defineBtnMouseExited(MouseEvent evt) { 
        ...
        Minesweeper.setStatusBar("Controls");
    }                                    
...
//        Sound.Menu3.stop();
        ...
        game.setMenu(null);
        game.stateManager.setState("menu");
        Minesweeper.setStatusBar("Define Keys Menu");
    }
    ...
    private void defKeysBtnMouseEntered(MouseEvent evt) {
        ...
        Minesweeper.setStatusBar("Default Keys");
    }                                     
