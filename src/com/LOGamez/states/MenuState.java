...
public class MenuState implements State {
    ...
    private int menuImageW = Minesweeper.getMainWidth()+12;
    
    /**menuImageH variable of MenuState*/
    private int menuImageH = Minesweeper.getMainHeight()-15;
    ...
    private int aboutBtnX = Minesweeper.getMainWidth() - 90;
    
    /**aboutBtnY variable of MenuState*/
    private int aboutBtnY = Minesweeper.getMainHeight() - 100;
    ...
    private int versionX = Minesweeper.getMainWidth() - 50;
    
    /**versionY variable of MenuState*/
    private int versionY = Minesweeper.getMainHeight() - 40;
...
//                    Sound.btnPushed.play();
            ...
            if (MouseInput.MouseX > optionsBtnX && MouseInput.MouseX < optionsBtnX + optionsBtnW && MouseInput.MouseY > optionsBtnY && MouseInput.MouseY < optionsBtnY + optionsBtnH) {
                ...
                Minesweeper.setStatusBar("Options");
...
//                    Sound.btnPushed.play();
		...
		Minesweeper.setStatusBar("Quit?");
                
                //Set Quit Button Click Logic
                if (MouseInput.MouseButton == 1) {
//                    Sound.stopAll();
//                    Sound.btnPushed.play();
                    Minesweeper.setStatusBar("Quit Game?");
		...
		Minesweeper.setStatusBar("About");
